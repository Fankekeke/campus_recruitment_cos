...
public class PostInfoController {
     ...
     * @return 结果
     */
    @GetMapping("/selectPostRecommend")
    public R selectPostRecommend(Page<PostInfo> page, PostInfo postInfo) {
        return R.ok(postInfoService.selectPostRecommend(page, postInfo));
    }

    @GetMapping("/queryPostRecommend")
    public R queryPostRecommend(Integer userId) {
        return R.ok(postInfoService.queryPostRecommend(userId));
    }
