<template>
  <a-modal v-model="show" title="面试详情" @cancel="onClose" :width="850">
    <template slot="footer">
      ...
      <a-button key="back" @click="onCheck(3)" type="danger" v-if="pluralismData.status == 1 || pluralismData.status == 2 || pluralismData.status == 4">
        驳回
      </a-button>
    </template>
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="pluralismData.status == 1">
      <a-row style="padding-left: 24px;padding-right: 24px;">
